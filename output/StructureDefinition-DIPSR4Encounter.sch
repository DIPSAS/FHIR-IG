...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Encounter">
      ...
      <sch:assert test="count(f:extension[@url = 'http://dips.no/fhir/R4/StructureDefinition/ReferredBy']) &lt;= 1">extension with URL = 'http://dips.no/fhir/R4/StructureDefinition/ReferredBy': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://dips.no/fhir/R4/StructureDefinition/DiagnoseGroupExtension']) &lt;= 1">extension with URL = 'http://dips.no/fhir/R4/StructureDefinition/DiagnoseGroupExtension': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://dips.no/fhir/R4/StructureDefinition/PlannedContactEndTimeExtension']) &lt;= 1">extension with URL = 'http://dips.no/fhir/R4/StructureDefinition/PlannedContactEndTimeExtension': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://dips.no/fhir/R4/StructureDefinition/TerminationExtension']) &lt;= 1">extension with URL = 'http://dips.no/fhir/R4/StructureDefinition/TerminationExtension': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://dips.no/fhir/R4/StructureDefinition/VideoUrl']) &lt;= 1">extension with URL = 'http://dips.no/fhir/R4/StructureDefinition/VideoUrl': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://dips.no/fhir/R4/StructureDefinition/DipsLocationExtension']) &lt;= 1">extension with URL = 'http://dips.no/fhir/R4/StructureDefinition/DipsLocationExtension': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://dips.no/fhir/R4/StructureDefinition/Department']) &lt;= 1">extension with URL = 'http://dips.no/fhir/R4/StructureDefinition/Department': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://dips.no/fhir/R4/StructureDefinition/SectionExtension']) &lt;= 1">extension with URL = 'http://dips.no/fhir/R4/StructureDefinition/SectionExtension': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://dips.no/fhir/R4/StructureDefinition/Reminder']) &lt;= 1">extension with URL = 'http://dips.no/fhir/R4/StructureDefinition/Reminder': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Encounter/f:meta">
      ...
      <sch:assert test="count(f:security) &lt;= 1">security: maximum cardinality of 'security' is 1</sch:assert>
      <sch:assert test="count(f:tag) &lt;= 1">tag: maximum cardinality of 'tag' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>f:Encounter/f:meta/f:security</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:Encounter/f:meta/f:tag</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:Encounter/f:classHistory/f:class</sch:title>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Encounter/f:location">
      <sch:assert test="count(f:id) &lt;= 0">id: maximum cardinality of 'id' is 0</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://dips.no/fhir/R4/StructureDefinition/BedTime']) &lt;= 1">extension with URL = 'http://dips.no/fhir/R4/StructureDefinition/BedTime': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
