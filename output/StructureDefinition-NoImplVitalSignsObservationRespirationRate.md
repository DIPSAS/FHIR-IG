# NoImplVitalSignsObservationRespirationRate - DIPS Core Implementation Guide v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **NoImplVitalSignsObservationRespirationRate**
...
* Examples for this Profile: [Observation/noImpl-respiratory-rate-create](Observation-noImpl-respiratory-rate-create.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/dips.fhir.no.core|current/StructureDefinition/StructureDefinition-NoImplVitalSignsObservationRespirationRate.json)
...
Other representations of profile: [CSV](StructureDefinition-NoImplVitalSignsObservationRespirationRate.csv), [Excel](StructureDefinition-NoImplVitalSignsObservationRespirationRate.xlsx), [Schematron](StructureDefinition-NoImplVitalSignsObservationRespirationRate.sch) 
...
```json
{
  ...
  "id" : "NoImplVitalSignsObservationRespirationRate",
  "url" : "http://dips.no/fhir/R4/StructureDefinition/NoImplVitalSignsObservationRespirationRate",
  "version" : "0.1.0",
  "name" : "NoImplVitalSignsObservationRespirationRate",
  "title" : "NoImplVitalSignsObservationRespirationRate",
  "status" : "draft",
  "date" : "2024-12-02",
  "publisher" : "DIPS AS",
  "contact" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://dips.no/fhir/R4/StructureDefinition/NoImplVitalSignsObservationRespirationRegularity"]
      }]
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://dips.no/fhir/R4/StructureDefinition/NoImplVitalSignsObservationRespirationDepth"]
      }]
    },
    {
