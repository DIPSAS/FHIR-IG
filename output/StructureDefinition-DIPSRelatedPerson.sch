...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile NoBasisRelatedPerson
  ...
  <sch:pattern>
    <sch:title>f:RelatedPerson/f:address/f:district</sch:title>
    <sch:rule context="f:RelatedPerson/f:address/f:district">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:RelatedPerson/f:address/f:period</sch:title>
