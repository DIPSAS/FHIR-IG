# no-respiratory-rate-create - DIPS Core Implementation Guide v0.1.0
...
Profile: [no-domain-VitalSigns-Observation-respirationrate Profile](https://hl7.no/fhir/no-domain/vitalsigns/StructureDefinition-no-domain-VitalSigns-Observation-respirationrate.html)
