...
| | |
| :--- | :--- |
| *Official URL*:http://dips.no/fhir/StructureDefinition/R4/DIPSPractitionerRoleUserRoleId | *Version*:0.1.0 |
| Draft as of 2026-09-15 | *Computable Name*:DIPSPractitionerRoleUserRoleId |
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      "id" : "Extension.url",
      "path" : "Extension.url",
      "fixedUri" : "http://dips.no/fhir/StructureDefinition/R4/DIPSPractitionerRoleUserRoleId"
    },
    {
