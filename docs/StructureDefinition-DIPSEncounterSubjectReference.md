# DIPSEncounterSubjectReference - DIPS Core Implementation Guide v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **DIPSEncounterSubjectReference**

## Resource Profile: DIPSEncounterSubjectReference 

| | |
| :--- | :--- |
| *Official URL*:http://dips.no/fhir/R4/StructureDefinition/DIPSEncounterSubjectReference | *Version*:0.1.0 |
| Draft as of 2026-09-03 | *Computable Name*:DIPSEncounterSubjectReference |

**Usages:**

* Refer to this Profile: [DIPSR4Encounter](StructureDefinition-DIPSR4Encounter.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/dips.fhir.no.core|current/StructureDefinition/StructureDefinition-DIPSEncounterSubjectReference.json)
...
Other representations of profile: [CSV](StructureDefinition-DIPSEncounterSubjectReference.csv), [Excel](StructureDefinition-DIPSEncounterSubjectReference.xlsx), [Schematron](StructureDefinition-DIPSEncounterSubjectReference.sch) 
...
```json
{
  ...
  "id" : "DIPSEncounterSubjectReference",
  "url" : "http://dips.no/fhir/R4/StructureDefinition/DIPSEncounterSubjectReference",
  "version" : "0.1.0",
