...
| | | |
| :--- | :--- | :--- |
| *Official URL*:http://dips.no/fhir/ValueSet/DIPSVitalSignsObservationConsciousness | *Version*:0.1.0 | |
| * Standards status: *[Draft](http://hl7.org/fhir/R4/versions.html#std-process) | [Maturity Level](http://hl7.org/fhir/versions.html#maturity): 1 | *Computable Name*:DIPSVitalSignsObservationConsciousness |
...
```json
{
  ...
  "url" : "http://dips.no/fhir/ValueSet/DIPSVitalSignsObservationConsciousness",
  "version" : "0.1.0",
