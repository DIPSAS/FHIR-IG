# no-body-height-create - DIPS Core Implementation Guide v0.1.0
...
Profile: [no-domain-VitalSigns-Observation-bodyheight Profile](https://hl7.no/fhir/no-domain/vitalsigns/StructureDefinition-no-domain-VitalSigns-Observation-bodyheight.html)
