...
| Draft as of 2026-09-17 | *Computable Name*:DepartmentTypeCodeId |
...
```json
{
  ...
  "url" : "http://DIPS.no/fhir/StructureDefinition/R4/DepartmentTypeCodeId",
  "version" : "0.1.0",
  ...
  "differential" : {
    ...
    },
    {
      "id" : "Extension.url",
      "path" : "Extension.url",
      "fixedUri" : "http://DIPS.no/fhir/StructureDefinition/R4/DepartmentTypeCodeId"
    },
    {
