# NoDomainVitalSignsObservationDiastolicendPoint - DIPS Core Implementation Guide v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **NoDomainVitalSignsObservationDiastolicendPoint**

## ValueSet: NoDomainVitalSignsObservationDiastolicendPoint 

| | | |
| :--- | :--- | :--- |
| *Official URL*:http://hl7.no/fhir/ValueSet/NoDomainVitalSignsObservationDiastolicendPoint | *Version*:0.1.0 | |
| * Standards status: *[Draft](http://hl7.org/fhir/R4/versions.html#std-process) | [Maturity Level](http://hl7.org/fhir/versions.html#maturity): 1 | *Computable Name*:NoDomainVitalSignsObservationDiastolicendPoint |
