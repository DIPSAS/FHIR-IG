...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Observation">
      ...
      <sch:assert test="count(f:extension[@url = 'http://hl7.no/fhir/no-domain/vitalsigns/StructureDefinition/NoDomainVitalSignsHeartRhythmIrregularityExtension']) &lt;= 0">extension with URL = 'http://hl7.no/fhir/no-domain/vitalsigns/StructureDefinition/NoDomainVitalSignsHeartRhythmIrregularityExtension': maximum cardinality of 'extension' is 0</sch:assert>
      ...
      <sch:assert test="count(f:extension[@url = 'http://dips.no/fhir/StructureDefinition/DIPSVitalSignsHeartRhythmIrregularity']) &lt;= 1">extension with URL = 'http://dips.no/fhir/StructureDefinition/DIPSVitalSignsHeartRhythmIrregularity': maximum cardinality of 'extension' is 1</sch:assert>
