...
| | |
| :--- | :--- |
| *Official URL*:http://dips.no/fhir/StructureDefinition/R4/DIPSPersonHospitalSectorName | *Version*:0.1.0 |
| Draft as of 2026-09-17 | *Computable Name*:DIPSPersonHospitalSectorName |
...
```json
{
  ...
  "url" : "http://dips.no/fhir/StructureDefinition/R4/DIPSPersonHospitalSectorName",
  "version" : "0.1.0",
  ...
  "differential" : {
    ...
    },
    {
      "id" : "Extension.url",
      "path" : "Extension.url",
      "fixedUri" : "http://dips.no/fhir/StructureDefinition/R4/DIPSPersonHospitalSectorName"
    },
    {
