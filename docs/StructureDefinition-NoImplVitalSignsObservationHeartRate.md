# NoImplVitalSignsObservationHeartRate - DIPS Core Implementation Guide v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **NoImplVitalSignsObservationHeartRate**

## Resource Profile: NoImplVitalSignsObservationHeartRate 

| | |
| :--- | :--- |
| *Official URL*:http://dips.no/fhir/R4/StructureDefinition/NoImplVitalSignsObservationHeartRate | *Version*:0.1.0 |
| Draft as of 2024-12-02 | *Computable Name*:NoImplVitalSignsObservationHeartRate |

 
The rate and associated attributes for a heart beat. 
...
* Examples for this Profile: [Observation/noimpl-heart-rate-create](Observation-noimpl-heart-rate-create.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/dips.fhir.no.core|current/StructureDefinition/StructureDefinition-NoImplVitalSignsObservationHeartRate.json)
...
Other representations of profile: [CSV](StructureDefinition-NoImplVitalSignsObservationHeartRate.csv), [Excel](StructureDefinition-NoImplVitalSignsObservationHeartRate.xlsx), [Schematron](StructureDefinition-NoImplVitalSignsObservationHeartRate.sch) 
...
```json
{
  ...
  "id" : "NoImplVitalSignsObservationHeartRate",
  "url" : "http://dips.no/fhir/R4/StructureDefinition/NoImplVitalSignsObservationHeartRate",
  "version" : "0.1.0",
  "name" : "NoImplVitalSignsObservationHeartRate",
  "title" : "NoImplVitalSignsObservationHeartRate",
  "status" : "draft",
  "date" : "2024-12-02",
  "publisher" : "DIPS AS",
  "contact" : [{
  ...
  "purpose" : "To record details about the rate and associated attributes for a  heart beat.",
  "fhirVersion" : "4.0.1",
  "mapping" : [{
    "identity" : "workflow",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "extensible",
        "valueSet" : "http://hl7.no/fhir/ValueSet/NoDomainVitalSignsObservationHeartRateBodySite"
      }
    },
    {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "extensible",
        "valueSet" : "http://dips.no/fhir/R4/ValueSet/NoImplVitalSignsObservationHeartRateMeasurementMethod"
      }
    },
    {
