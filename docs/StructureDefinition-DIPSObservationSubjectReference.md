# DIPSObservationSubjectReference - DIPS Core Implementation Guide v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **DIPSObservationSubjectReference**

## Resource Profile: DIPSObservationSubjectReference 

| | |
| :--- | :--- |
| *Official URL*:http://dips.no/fhir/StructureDefinition/DIPSObservationSubjectReference | *Version*:0.1.0 |
| Draft as of 2026-09-17 | *Computable Name*:DIPSObservationSubjectReference |

**Usages:**

* Refer to this Profile: [DIPSBasisLabObservationR4](StructureDefinition-DIPSBasisLabObservationR4.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/dips.fhir.no.core|current/StructureDefinition/StructureDefinition-DIPSObservationSubjectReference.json)
...
Other representations of profile: [CSV](StructureDefinition-DIPSObservationSubjectReference.csv), [Excel](StructureDefinition-DIPSObservationSubjectReference.xlsx), [Schematron](StructureDefinition-DIPSObservationSubjectReference.sch) 
...
```json
{
  ...
  "id" : "DIPSObservationSubjectReference",
  "url" : "http://dips.no/fhir/StructureDefinition/DIPSObservationSubjectReference",
  "version" : "0.1.0",
