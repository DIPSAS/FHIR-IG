# DIPS Vital Signs Observation - Pulse - DIPS Core Implementation Guide v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **DIPS Vital Signs Observation - Pulse**

## Resource Profile: DIPS Vital Signs Observation - Pulse 

| | |
| :--- | :--- |
| *Official URL*:http://dips.no/fhir/StructureDefinition/DIPSVitalSignsObservationPulse | *Version*:0.1.0 |
| Draft as of 2026-09-18 | *Computable Name*:DIPSVitalSignsObservationPulse |

 
DIPS profile for Pulse including some extensions 

The DIPS Pulse Profile inherits from the FHIR Observation resource; refer to it for scope and usage definitions

**Example Usage Scenarios:**

The following are example usage scenarios for this profile:

Query the recorded Pulse observation(s) belonging to one clinical document (journal entry)

**Usages:**

* This Profile is not used by any profiles in this Specification

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/dips.fhir.no.core|current/StructureDefinition/StructureDefinition-DIPSVitalSignsObservationPulse.json)
...
Other representations of profile: [CSV](StructureDefinition-DIPSVitalSignsObservationPulse.csv), [Excel](StructureDefinition-DIPSVitalSignsObservationPulse.xlsx), [Schematron](StructureDefinition-DIPSVitalSignsObservationPulse.sch) 
...
1. GET [base]/Observation?documentId=1009280
...
1. GET [base]/Observation?documentId=1009280&_profile=DIPSVitalSignsObservationPulse
...
```json
{
  ...
  "version" : "0.1.0",
  "name" : "DIPSVitalSignsObservationPulse",
  ...
  "abstract" : false,
  "type" : "Observation",
  "baseDefinition" : "http://hl7.no/fhir/no-domain/vitalsigns/StructureDefinition/no-domain-VitalSigns-Observation-pulse",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "http://dips.no/fhir/ValueSet/DIPSVitalSignsObservationPulseBodySite"
      }
    },
    {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "http://dips.no/fhir/ValueSet/DIPSVitalSignsObservationPulseMeasurementMethod"
      }
    },
    {
