# DipsPatientMunicipality - DIPS Core Implementation Guide v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **DipsPatientMunicipality**

## Extension: DipsPatientMunicipality 

| | |
| :--- | :--- |
| *Official URL*:http://dips.no/fhir/R4/StructureDefinition/DipsPatientMunicipality | *Version*:0.1.0 |
| Draft as of 2026-08-20 | *Computable Name*:DipsPatientMunicipality |
...
Other representations of profile: [CSV](StructureDefinition-DipsPatientMunicipality.csv), [Excel](StructureDefinition-DipsPatientMunicipality.xlsx), [Schematron](StructureDefinition-DipsPatientMunicipality.sch) 
