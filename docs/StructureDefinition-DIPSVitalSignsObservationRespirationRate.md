# DIPS Vital Signs Observation - Respiration Rate - DIPS Core Implementation Guide v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **DIPS Vital Signs Observation - Respiration Rate**

## Resource Profile: DIPS Vital Signs Observation - Respiration Rate 

| | |
| :--- | :--- |
| *Official URL*:http://dips.no/fhir/StructureDefinition/DIPSVitalSignsObservationRespirationRate | *Version*:0.1.0 |
| Draft as of 2026-09-18 | *Computable Name*:DIPSVitalSignsObservationRespirationRate |

 
DIPS profile for Respiration Rate including some extensions 

The DIPS Respiration Rate Profile inherits from the FHIR Observation resource; refer to it for scope and usage definitions

**Example Usage Scenarios:**

The following are example usage scenarios for this profile:

Query the recorded Respiration Rate observation(s) belonging to one clinical document (journal entry)

**Usages:**

* Examples for this Profile: [Observation/dips-respiratory-rate-create](Observation-dips-respiratory-rate-create.md)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/dips.fhir.no.core|current/StructureDefinition/StructureDefinition-DIPSVitalSignsObservationRespirationRate.json)
...
Other representations of profile: [CSV](StructureDefinition-DIPSVitalSignsObservationRespirationRate.csv), [Excel](StructureDefinition-DIPSVitalSignsObservationRespirationRate.xlsx), [Schematron](StructureDefinition-DIPSVitalSignsObservationRespirationRate.sch) 
...
1. GET [base]/Observation?documentId=1009432
...
1. GET [base]/Observation?documentId=1009432&_profile=DIPSVitalSignsObservationRespirationRate
...
```json
{
  ...
  "version" : "0.1.0",
  "name" : "DIPSVitalSignsObservationRespirationRate",
  ...
  "abstract" : false,
  "type" : "Observation",
  "baseDefinition" : "http://hl7.no/fhir/no-domain/vitalsigns/StructureDefinition/no-domain-VitalSigns-Observation-respirationrate",
