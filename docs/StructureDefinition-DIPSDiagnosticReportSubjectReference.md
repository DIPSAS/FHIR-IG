# DIPSDiagnosticReportSubjectReference - DIPS Core Implementation Guide v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **DIPSDiagnosticReportSubjectReference**

## Resource Profile: DIPSDiagnosticReportSubjectReference 

| | |
| :--- | :--- |
| *Official URL*:http://dips.no/fhir/StructureDefinition/DIPSDiagnosticReportSubjectReference | *Version*:0.1.0 |
| Draft as of 2026-09-18 | *Computable Name*:DIPSDiagnosticReportSubjectReference |

**Usages:**

* Refer to this Profile: [DIPS DiagnosticReport](StructureDefinition-DIPSDiagnosticReport.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/dips.fhir.no.core|current/StructureDefinition/StructureDefinition-DIPSDiagnosticReportSubjectReference.json)
...
Other representations of profile: [CSV](StructureDefinition-DIPSDiagnosticReportSubjectReference.csv), [Excel](StructureDefinition-DIPSDiagnosticReportSubjectReference.xlsx), [Schematron](StructureDefinition-DIPSDiagnosticReportSubjectReference.sch) 
...
```json
{
  ...
  "id" : "DIPSDiagnosticReportSubjectReference",
  "url" : "http://dips.no/fhir/StructureDefinition/DIPSDiagnosticReportSubjectReference",
  "version" : "0.1.0",
