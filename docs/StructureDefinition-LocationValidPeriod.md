...
| | |
| :--- | :--- |
| *Official URL*:http://DIPS.no/fhir/StructureDefinition/R4/Location-validPeriod | *Version*:0.1.0 |
| Draft as of 2026-09-17 | *Computable Name*:LocationValidPeriod |
...
```json
{
  ...
  "url" : "http://DIPS.no/fhir/StructureDefinition/R4/Location-validPeriod",
  "version" : "0.1.0",
  ...
  "differential" : {
    ...
    },
    {
      "id" : "Extension.url",
      "path" : "Extension.url",
      "fixedUri" : "http://DIPS.no/fhir/StructureDefinition/R4/Location-validPeriod"
    },
    {
