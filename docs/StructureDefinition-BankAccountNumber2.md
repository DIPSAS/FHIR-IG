# BankAccountNumber2 - DIPS Core Implementation Guide v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **BankAccountNumber2**

## Extension: BankAccountNumber2 

| | |
| :--- | :--- |
| *Official URL*:http://dips.no/fhir/R4/StructureDefinition/BankAccountNumber2 | *Version*:0.1.0 |
| Draft as of 2026-08-31 | *Computable Name*:BankAccountNumber2 |
...
Other representations of profile: [CSV](StructureDefinition-BankAccountNumber2.csv), [Excel](StructureDefinition-BankAccountNumber2.xlsx), [Schematron](StructureDefinition-BankAccountNumber2.sch) 
