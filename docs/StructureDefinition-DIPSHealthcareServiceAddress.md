...
| | |
| :--- | :--- |
| *Official URL*:http://dips.no/fhir/StructureDefinition/R4/DIPSHealthcareServiceAddress | *Version*:0.1.0 |
| Draft as of 2026-09-17 | *Computable Name*:DIPSHealthcareServiceAddress |
...
```json
{
  ...
  "url" : "http://dips.no/fhir/StructureDefinition/R4/DIPSHealthcareServiceAddress",
  "version" : "0.1.0",
  ...
  "differential" : {
    ...
    },
    {
      "id" : "Extension.url",
      "path" : "Extension.url",
      "fixedUri" : "http://dips.no/fhir/StructureDefinition/R4/DIPSHealthcareServiceAddress"
    },
    {
