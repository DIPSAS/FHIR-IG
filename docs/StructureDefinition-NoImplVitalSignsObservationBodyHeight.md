# NoImplVitalSignsObservationBodyHeight - DIPS Core Implementation Guide v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **NoImplVitalSignsObservationBodyHeight**

## Resource Profile: NoImplVitalSignsObservationBodyHeight 

| | |
| :--- | :--- |
| *Official URL*:http://dips.no/fhir/R4/StructureDefinition/NoImplVitalSignsObservationBodyHeight | *Version*:0.1.0 |
| Draft as of 2025-01-28 | *Computable Name*:NoImplVitalSignsObservationBodyHeight |
...
* Examples for this Profile: [Observation/noimpl-body-height-create](Observation-noimpl-body-height-create.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/dips.fhir.no.core|current/StructureDefinition/StructureDefinition-NoImplVitalSignsObservationBodyHeight.json)
...
Other representations of profile: [CSV](StructureDefinition-NoImplVitalSignsObservationBodyHeight.csv), [Excel](StructureDefinition-NoImplVitalSignsObservationBodyHeight.xlsx), [Schematron](StructureDefinition-NoImplVitalSignsObservationBodyHeight.sch) 
...
```json
{
  ...
  "id" : "NoImplVitalSignsObservationBodyHeight",
  "url" : "http://dips.no/fhir/R4/StructureDefinition/NoImplVitalSignsObservationBodyHeight",
  "version" : "0.1.0",
  "name" : "NoImplVitalSignsObservationBodyHeight",
  "title" : "NoImplVitalSignsObservationBodyHeight",
  "status" : "draft",
  "date" : "2025-01-28",
  "publisher" : "DIPS AS",
  "contact" : [{
