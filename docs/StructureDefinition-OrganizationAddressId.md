...
| | |
| :--- | :--- |
| *Official URL*:http://DIPS.no/fhir/StructureDefinition/R4/Organization-addressId | *Version*:0.1.0 |
| Draft as of 2026-09-18 | *Computable Name*:OrganizationAddressId |
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      "id" : "Extension.url",
      "path" : "Extension.url",
      "fixedUri" : "http://DIPS.no/fhir/StructureDefinition/R4/Organization-addressId"
    },
    {
