...
| | |
| :--- | :--- |
| *Official URL*:http://dips.no/fhir/StructureDefinition/R4/DIPSPractitionerRoleIsPaperCopy | *Version*:0.1.0 |
| Draft as of 2026-09-15 | *Computable Name*:DIPSPractitionerRoleIsPaperCopy |
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      "id" : "Extension.url",
      "path" : "Extension.url",
      "fixedUri" : "http://dips.no/fhir/StructureDefinition/R4/DIPSPractitionerRoleIsPaperCopy"
    },
    {
