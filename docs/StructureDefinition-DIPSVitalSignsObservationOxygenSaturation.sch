...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Observation">
      ...
      <sch:assert test="count(f:extension[@url = 'http://dips.no/fhir/StructureDefinition/DIPSVitalSignsObservationPrePostduktal']) &lt;= 1">extension with URL = 'http://dips.no/fhir/StructureDefinition/DIPSVitalSignsObservationPrePostduktal': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://dips.no/fhir/StructureDefinition/DIPSLocation']) &lt;= 1">extension with URL = 'http://dips.no/fhir/StructureDefinition/DIPSLocation': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Observation/f:extension">
      ...
      <sch:assert test="count(f:extension[@url = 'http://hl7.no/fhir/no-domain/vitalsigns/StructureDefinition/NoDomainVitalSignsFiO2Extension']) &lt;= 0">extension with URL = 'http://hl7.no/fhir/no-domain/vitalsigns/StructureDefinition/NoDomainVitalSignsFiO2Extension': maximum cardinality of 'extension' is 0</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://hl7.no/fhir/no-domain/vitalsigns/StructureDefinition/NoDomainVitalSignsPercentO2Extension']) &lt;= 0">extension with URL = 'http://hl7.no/fhir/no-domain/vitalsigns/StructureDefinition/NoDomainVitalSignsPercentO2Extension': maximum cardinality of 'extension' is 0</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://hl7.no/fhir/no-domain/vitalsigns/StructureDefinition/NoDomainVitalSignsOnAirExtension']) &lt;= 0">extension with URL = 'http://hl7.no/fhir/no-domain/vitalsigns/StructureDefinition/NoDomainVitalSignsOnAirExtension': maximum cardinality of 'extension' is 0</sch:assert>
