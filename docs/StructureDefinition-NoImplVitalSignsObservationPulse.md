# NoImplVitalSignsObservationPulse - DIPS Core Implementation Guide v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **NoImplVitalSignsObservationPulse**

## Resource Profile: NoImplVitalSignsObservationPulse 

| | |
| :--- | :--- |
| *Official URL*:http://dips.no/fhir/R4/StructureDefinition/NoImplVitalSignsObservationPulse | *Version*:0.1.0 |
| Draft as of 2024-12-02 | *Computable Name*:NoImplVitalSignsObservationPulse |

 
The rate and associated attributes for a pulse. 

 
To record details about the rate and associated attributes for a pulse. 

**Usages:**

* Examples for this Profile: [Observation/noimpl-pulse-rate](Observation-noimpl-pulse-rate.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/dips.fhir.no.core|current/StructureDefinition/StructureDefinition-NoImplVitalSignsObservationPulse.json)
...
Other representations of profile: [CSV](StructureDefinition-NoImplVitalSignsObservationPulse.csv), [Excel](StructureDefinition-NoImplVitalSignsObservationPulse.xlsx), [Schematron](StructureDefinition-NoImplVitalSignsObservationPulse.sch) 
...
```json
{
  ...
  "id" : "NoImplVitalSignsObservationPulse",
  "url" : "http://dips.no/fhir/R4/StructureDefinition/NoImplVitalSignsObservationPulse",
  "version" : "0.1.0",
  "name" : "NoImplVitalSignsObservationPulse",
  "title" : "NoImplVitalSignsObservationPulse",
  "status" : "draft",
  "date" : "2024-12-02",
  "publisher" : "DIPS AS",
  "contact" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://dips.no/fhir/R4/StructureDefinition/NoImplVitalSignsObservationPulseRhythm"]
      }]
    },
    {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "extensible",
        "valueSet" : "http://dips.no/fhir/R4/ValueSet/NoImplVitalSignsObservationPulseBodySite"
      }
    },
    {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "extensible",
        "valueSet" : "http://dips.no/fhir/R4/ValueSet/NoImplVitalSignsObservationPulseMeasurementMethod"
      }
    },
    {
