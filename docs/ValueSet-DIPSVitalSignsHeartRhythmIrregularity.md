...
## ValueSet: DIPSVitalSignsHeartRhythmIrregularity 

| | | |
| :--- | :--- | :--- |
| *Official URL*:http://dips.no/fhir/ValueSet/DIPSVitalSignsHeartRhythmIrregularity | *Version*:0.1.0 | |
| * Standards status: *[Draft](http://hl7.org/fhir/R4/versions.html#std-process) | [Maturity Level](http://hl7.org/fhir/versions.html#maturity): 1 | *Computable Name*:DIPSVitalSignsHeartRhythmIrregularity |
...
```json
{
  ...
  "url" : "http://dips.no/fhir/ValueSet/DIPSVitalSignsHeartRhythmIrregularity",
  "version" : "0.1.0",
  "name" : "DIPSVitalSignsHeartRhythmIrregularity",
  "title" : "DIPSVitalSignsHeartRhythmIrregularity",
  "status" : "draft",
  "experimental" : false,
