...
| | |
| :--- | :--- |
| *Official URL*:http://dips.no/fhir/StructureDefinition/R4/DIPSPractitionerRoleDipsSignature | *Version*:0.1.0 |
| Draft as of 2026-09-18 | *Computable Name*:DIPSPractitionerRoleDipsSignature |
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      "id" : "Extension.url",
      "path" : "Extension.url",
      "fixedUri" : "http://dips.no/fhir/StructureDefinition/R4/DIPSPractitionerRoleDipsSignature"
    },
    {
