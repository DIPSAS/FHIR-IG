...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile NoBasisHealthcareService
  ...
  <sch:pattern>
    <sch:title>f:HealthcareService/f:communication/f:coding</sch:title>
    <sch:rule context="f:HealthcareService/f:communication/f:coding">
  ...
  <sch:pattern>
    <sch:title>f:HealthcareService/f:communication/f:coding/f:extension</sch:title>
    <sch:rule context="f:HealthcareService/f:communication/f:coding/f:extension">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:url) &gt;= 1">url: minimum cardinality of 'url' is 1</sch:assert>
      <sch:assert test="count(f:url) &lt;= 1">url: maximum cardinality of 'url' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:HealthcareService/f:communication/f:coding/f:extension/f:value[x] 1</sch:title>
    <sch:rule context="f:HealthcareService/f:communication/f:coding/f:extension/f:value[x]">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:system) &lt;= 1">system: maximum cardinality of 'system' is 1</sch:assert>
      <sch:assert test="count(f:version) &lt;= 0">version: maximum cardinality of 'version' is 0</sch:assert>
      <sch:assert test="count(f:code) &lt;= 1">code: maximum cardinality of 'code' is 1</sch:assert>
