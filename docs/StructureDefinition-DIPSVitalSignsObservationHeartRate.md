# DIPS Vital Signs Observation - Heart Rate - DIPS Core Implementation Guide v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **DIPS Vital Signs Observation - Heart Rate**

## Resource Profile: DIPS Vital Signs Observation - Heart Rate 
...
The DIPS Heart Rate Profile inherits from the FHIR Observation resource; refer to it for scope and usage definitions

**Example Usage Scenarios:**

The following are example usage scenarios for this profile:

Query the recorded Heart Rate observation(s) belonging to one clinical document (journal entry)

**Usages:**

* Examples for this Profile: [Observation/dips-heart-rate-create](Observation-dips-heart-rate-create.md)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/dips.fhir.no.core|current/StructureDefinition/StructureDefinition-DIPSVitalSignsObservationHeartRate.json)
...
Other representations of profile: [CSV](StructureDefinition-DIPSVitalSignsObservationHeartRate.csv), [Excel](StructureDefinition-DIPSVitalSignsObservationHeartRate.xlsx), [Schematron](StructureDefinition-DIPSVitalSignsObservationHeartRate.sch) 
...
1. GET [base]/Observation?documentId=1009240
...
1. GET [base]/Observation?documentId=1009240&_profile=DIPSVitalSignsObservationHeartRate
...
```json
{
  ...
  "abstract" : false,
  "type" : "Observation",
  "baseDefinition" : "http://hl7.no/fhir/no-domain/vitalsigns/StructureDefinition/no-domain-VitalSigns-Observation-heartrate",
  ...
  "differential" : {
    ...
    {
      "id" : "Observation.extension:DIPSheartRhythmIrregularity",
      "path" : "Observation.extension",
      "sliceName" : "DIPSheartRhythmIrregularity",
      "min" : 0,
      "max" : "1",
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://dips.no/fhir/StructureDefinition/DIPSVitalSignsHeartRhythmIrregularity"]
      }]
    },
    {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "http://dips.no/fhir/ValueSet/DIPSVitalSignsObservationHeartRateMeasurementMethod"
      }
    },
    {
