...
| | |
| :--- | :--- |
| *Official URL*:http://dips.no/fhir/StructureDefinition/R4/LastOfficialAddressSyncTime | *Version*:0.1.0 |
| Draft as of 2026-09-15 | *Computable Name*:LastOfficialAddressSyncTime |
...
```json
{
  ...
  "url" : "http://dips.no/fhir/StructureDefinition/R4/LastOfficialAddressSyncTime",
  "version" : "0.1.0",
  ...
  "differential" : {
    ...
    },
    {
      "id" : "Extension.url",
      "path" : "Extension.url",
      "fixedUri" : "http://dips.no/fhir/StructureDefinition/R4/LastOfficialAddressSyncTime"
    },
    {
