# noimpl-body-weight-create - DIPS Core Implementation Guide v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **noimpl-body-weight-create**

## Example Observation: noimpl-body-weight-create
...
```json
{
  ...
  "meta" : {
    ...
    "source" : "NoImpl",
    "profile" : ["http://dips.no/fhir/R4/StructureDefinition/NoImplVitalSignsObservationBodyWeight"]
  },
  "extension" : [{
