...
| | |
| :--- | :--- |
| *Official URL*:http://dips.no/fhir/StructureDefinition/R4/DIPSPractitionerRoleHealthCarePartyType | *Version*:0.1.0 |
| Draft as of 2026-09-08 | *Computable Name*:DIPSPractitionerRoleHealthCarePartyType |
...
```json
{
  ...
  "differential" : {
    "element" : [{
      "id" : "Extension.url",
      "path" : "Extension.url",
      "fixedUri" : "http://dips.no/fhir/StructureDefinition/R4/DIPSPractitionerRoleHealthCarePartyType"
    }]
  }
}
