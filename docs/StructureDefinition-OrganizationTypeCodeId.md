...
| | |
| :--- | :--- |
| *Official URL*:http://DIPS.no/fhir/StructureDefinition/R4/OrganizationTypeCodeId | *Version*:0.1.0 |
| Draft as of 2026-09-15 | *Computable Name*:OrganizationTypeCodeId |
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      "id" : "Extension.url",
      "path" : "Extension.url",
      "fixedUri" : "http://DIPS.no/fhir/StructureDefinition/R4/OrganizationTypeCodeId"
    },
    {
