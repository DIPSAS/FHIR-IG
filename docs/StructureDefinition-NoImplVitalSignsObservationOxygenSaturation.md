# NoImplVitalSignsObservationOxygenSaturation - DIPS Core Implementation Guide v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **NoImplVitalSignsObservationOxygenSaturation**

## Resource Profile: NoImplVitalSignsObservationOxygenSaturation 

| | |
| :--- | :--- |
| *Official URL*:http://dips.no/fhir/R4/StructureDefinition/NoImplVitalSignsObservationOxygenSaturation | *Version*:0.1.0 |
| Draft as of 2025-01-28 | *Computable Name*:NoImplVitalSignsObservationOxygenSaturation |
...
* Examples for this Profile: [Observation/noimpl-oxygen-saturation-create](Observation-noimpl-oxygen-saturation-create.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/dips.fhir.no.core|current/StructureDefinition/StructureDefinition-NoImplVitalSignsObservationOxygenSaturation.json)
...
Other representations of profile: [CSV](StructureDefinition-NoImplVitalSignsObservationOxygenSaturation.csv), [Excel](StructureDefinition-NoImplVitalSignsObservationOxygenSaturation.xlsx), [Schematron](StructureDefinition-NoImplVitalSignsObservationOxygenSaturation.sch) 
...
```json
{
  ...
  "id" : "NoImplVitalSignsObservationOxygenSaturation",
  "url" : "http://dips.no/fhir/R4/StructureDefinition/NoImplVitalSignsObservationOxygenSaturation",
  "version" : "0.1.0",
  "name" : "NoImplVitalSignsObservationOxygenSaturation",
  "title" : "NoImplVitalSignsObservationOxygenSaturation",
  "status" : "draft",
  "date" : "2025-01-28",
  "publisher" : "DIPS AS",
  "contact" : [{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://dips.no/fhir/R4/StructureDefinition/NoImplVitalSignsObservationInspiredOxygen"]
      }]
    },
    {
