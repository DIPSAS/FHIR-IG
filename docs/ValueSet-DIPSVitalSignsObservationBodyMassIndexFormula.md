...
## ValueSet: DIPSVitalSignsObservationBodyMassIndexFormula 

| | | |
| :--- | :--- | :--- |
| *Official URL*:http://dips.no/fhir/ValueSet/DIPSVitalSignsObservationBodyMassIndexFormula | *Version*:0.1.0 | |
| * Standards status: *[Draft](http://hl7.org/fhir/R4/versions.html#std-process) | [Maturity Level](http://hl7.org/fhir/versions.html#maturity): 1 | *Computable Name*:DIPSVitalSignsObservationBodyMassIndexFormula |
...
```json
{
  ...
  "url" : "http://dips.no/fhir/ValueSet/DIPSVitalSignsObservationBodyMassIndexFormula",
  "version" : "0.1.0",
  "name" : "DIPSVitalSignsObservationBodyMassIndexFormula",
  "title" : "DIPSVitalSignsObservationBodyMassIndexFormula",
  "status" : "draft",
  "experimental" : false,
