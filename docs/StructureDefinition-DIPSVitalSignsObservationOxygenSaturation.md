# DIPS Vital Signs Observation - Oxygen Saturation - DIPS Core Implementation Guide v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **DIPS Vital Signs Observation - Oxygen Saturation**

## Resource Profile: DIPS Vital Signs Observation - Oxygen Saturation 

| | |
| :--- | :--- |
| *Official URL*:http://dips.no/fhir/StructureDefinition/DIPSVitalSignsObservationOxygenSaturation | *Version*:0.1.0 |
| Draft as of 2026-09-18 | *Computable Name*:DIPSVitalSignsObservationOxygenSaturation |

 
DIPS profile for Oxygen Saturation including some extensions 

The DIPS Oxygen Saturation Profile inherits from the FHIR Observation resource; refer to it for scope and usage definitions

**Example Usage Scenarios:**

The following are example usage scenarios for this profile:

Query the recorded Oxygen Saturation observation(s) belonging to one clinical document (journal entry)

**Usages:**

* Examples for this Profile: [Observation/dips-oxygen-saturation-create](Observation-dips-oxygen-saturation-create.md)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/dips.fhir.no.core|current/StructureDefinition/StructureDefinition-DIPSVitalSignsObservationOxygenSaturation.json)
...
Other representations of profile: [CSV](StructureDefinition-DIPSVitalSignsObservationOxygenSaturation.csv), [Excel](StructureDefinition-DIPSVitalSignsObservationOxygenSaturation.xlsx), [Schematron](StructureDefinition-DIPSVitalSignsObservationOxygenSaturation.sch) 
...
1. GET [base]/Observation?documentId=1009312
...
1. GET [base]/Observation?documentId=1009312&_profile=DIPSVitalSignsObservationOxygenSaturation
...
```json
{
  ...
  "version" : "0.1.0",
  "name" : "DIPSVitalSignsObservationOxygenSaturation",
  ...
  "abstract" : false,
  "type" : "Observation",
  "baseDefinition" : "http://hl7.no/fhir/no-domain/vitalsigns/StructureDefinition/no-domain-VitalSigns-Observation-oxygensaturation",
  ...
  "differential" : {
    ...
    {
      "id" : "Observation.extension:inspiredOxygen.extension:FiO2",
      "path" : "Observation.extension.extension",
      "sliceName" : "FiO2",
      "max" : "0"
    },
    {
      "id" : "Observation.extension:inspiredOxygen.extension:PrecentO2",
      "path" : "Observation.extension.extension",
      "sliceName" : "PrecentO2",
      "max" : "0"
    },
    {
      "id" : "Observation.extension:inspiredOxygen.extension:OnAir",
      "path" : "Observation.extension.extension",
      "sliceName" : "OnAir",
      "max" : "0"
    },
    ...
    {
      "id" : "Observation.extension:PrePostduktal",
      "path" : "Observation.extension",
      "sliceName" : "PrePostduktal",
      "min" : 0,
      "max" : "1",
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://dips.no/fhir/StructureDefinition/DIPSVitalSignsObservationPrePostduktal"]
      }]
    },
    {
