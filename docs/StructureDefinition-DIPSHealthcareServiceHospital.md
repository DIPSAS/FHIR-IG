...
| | |
| :--- | :--- |
| *Official URL*:http://dips.no/fhir/StructureDefinition/R4/DIPSHealthcareServiceHospital | *Version*:0.1.0 |
| Draft as of 2026-09-15 | *Computable Name*:DIPSHealthcareServiceHospital |
...
```json
{
  ...
  "url" : "http://dips.no/fhir/StructureDefinition/R4/DIPSHealthcareServiceHospital",
  "version" : "0.1.0",
  ...
  "differential" : {
    ...
    },
    {
      "id" : "Extension.url",
      "path" : "Extension.url",
      "fixedUri" : "http://dips.no/fhir/StructureDefinition/R4/DIPSHealthcareServiceHospital"
    },
    {
