# NoDomainVitalSignsObservationPulseBodySite - DIPS Core Implementation Guide v0.1.0
...
| | | |
| :--- | :--- | :--- |
| *Official URL*:http://hl7.no/fhir/ValueSet/NoDomainVitalSignsObservationPulseBodySite | *Version*:0.1.0 | |
| * Standards status: *[Draft](http://hl7.org/fhir/R4/versions.html#std-process) | [Maturity Level](http://hl7.org/fhir/versions.html#maturity): 1 | *Computable Name*:NoDomainVitalSignsObservationPulseBodySite |
...
* Included into [NoImplVitalSignsObservationPulseBodySite](ValueSet-NoImplVitalSignsObservationPulseBodySite.md)
