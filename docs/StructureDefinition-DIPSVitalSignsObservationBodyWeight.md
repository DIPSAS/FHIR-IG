# DIPS Vital Signs Observation - Body Weight - DIPS Core Implementation Guide v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **DIPS Vital Signs Observation - Body Weight**

## Resource Profile: DIPS Vital Signs Observation - Body Weight 

| | |
| :--- | :--- |
| *Official URL*:http://dips.no/fhir/StructureDefinition/DIPSVitalSignsObservationBodyWeight | *Version*:0.1.0 |
| Draft as of 2026-09-17 | *Computable Name*:DIPSVitalSignsObservationBodyWeight |

 
DIPS profile for Body Weight including some extensions 

The DIPS Body Weight Profile inherits from the FHIR Observation resource; refer to it for scope and usage definitions

**Example Usage Scenarios:**

The following are example usage scenarios for this profile:

Query the recorded Body Weight observation(s) belonging to one clinical document (journal entry)

**Usages:**

* Examples for this Profile: [Observation/dips-body-weight-create](Observation-dips-body-weight-create.md)
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/dips.fhir.no.core|current/StructureDefinition/StructureDefinition-DIPSVitalSignsObservationBodyWeight.json)
...
Other representations of profile: [CSV](StructureDefinition-DIPSVitalSignsObservationBodyWeight.csv), [Excel](StructureDefinition-DIPSVitalSignsObservationBodyWeight.xlsx), [Schematron](StructureDefinition-DIPSVitalSignsObservationBodyWeight.sch) 
...
1. GET [base]/Observation?documentId=1009026
...
1. GET [base]/Observation?documentId=1009026&_profile=DIPSVitalSignsObservationBodyWeight
...
```json
{
  ...
  "version" : "0.1.0",
  "name" : "DIPSVitalSignsObservationBodyWeight",
  ...
  "abstract" : false,
  "type" : "Observation",
  "baseDefinition" : "http://hl7.no/fhir/no-domain/vitalsigns/StructureDefinition/no-domain-VitalSigns-Observation-bodyweight",
