...
| | |
| :--- | :--- |
| *Official URL*:http://dips.no/fhir/StructureDefinition/R4/DIPSPractitionerRoleCommunicationTypeId | *Version*:0.1.0 |
| Draft as of 2026-09-17 | *Computable Name*:DIPSPractitionerRoleCommunicationTypeId |
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      "id" : "Extension.url",
      "path" : "Extension.url",
      "fixedUri" : "http://dips.no/fhir/StructureDefinition/R4/DIPSPractitionerRoleCommunicationTypeId"
    },
    {
