# DipsPatientPhoneTypeId - DIPS Core Implementation Guide v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **DipsPatientPhoneTypeId**

## Extension: DipsPatientPhoneTypeId 

| | |
| :--- | :--- |
| *Official URL*:http://dips.no/fhir/R4/StructureDefinition/DipsPatientPhoneTypeId | *Version*:0.1.0 |
| Draft as of 2026-08-31 | *Computable Name*:DipsPatientPhoneTypeId |
...
Other representations of profile: [CSV](StructureDefinition-DipsPatientPhoneTypeId.csv), [Excel](StructureDefinition-DipsPatientPhoneTypeId.xlsx), [Schematron](StructureDefinition-DipsPatientPhoneTypeId.sch) 
