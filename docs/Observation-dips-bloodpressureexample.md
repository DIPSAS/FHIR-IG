# dips-bloodpressureexample - DIPS Core Implementation Guide v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **dips-bloodpressureexample**

## Example Observation: dips-bloodpressureexample
...
**identifier**: `http://dips.no/fhir/namingsystem/externalId`/ExtIdentifierKal0011s1, `http://dips.no/fhir/namingsystem/dips-ObservationId`/dips-bloodpressureexample, `http://dips.no/fhir/namingsystem/dips-RelativeEhrUri`/ehr:compositions/a6a969c2-fb92-435f-93cd-f5653fceb33c::default::1/content[openEHR-EHR-OBSERVATION.blood_pressure.v2 and name/value='Blodtrykk']
...
```json
{
  ...
  "identifier" : [{
    ...
    "value" : "ExtIdentifierKal0011s1"
  },
  {
    "system" : "http://dips.no/fhir/namingsystem/dips-ObservationId",
    "value" : "dips-bloodpressureexample"
  },
  {
    "system" : "http://dips.no/fhir/namingsystem/dips-RelativeEhrUri",
    "value" : "ehr:compositions/a6a969c2-fb92-435f-93cd-f5653fceb33c::default::1/content[openEHR-EHR-OBSERVATION.blood_pressure.v2 and name/value='Blodtrykk']"
  }],
  "status" : "final",
  "category" : [{
    "coding" : [{
