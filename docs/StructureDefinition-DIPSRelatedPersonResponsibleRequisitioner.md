...
| | |
| :--- | :--- |
| *Official URL*:http://dips.no/fhir/StructureDefinition/R4/DIPSRelatedPersonResponsibleRequisitioner | *Version*:0.1.0 |
| Draft as of 2026-09-08 | *Computable Name*:DIPSRelatedPersonResponsibleRequisitioner |
...
```json
{
  ...
  "url" : "http://dips.no/fhir/StructureDefinition/R4/DIPSRelatedPersonResponsibleRequisitioner",
  "version" : "0.1.0",
  ...
  "differential" : {
    ...
    },
    {
      "id" : "Extension.url",
      "path" : "Extension.url",
      "fixedUri" : "http://dips.no/fhir/StructureDefinition/R4/DIPSRelatedPersonResponsibleRequisitioner"
    },
    {
