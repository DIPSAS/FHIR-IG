...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Observation">
      ...
      <sch:assert test="count(f:extension[@url = 'http://dips.no/fhir/R4/StructureDefinition/NoImplVitalSignsObservationRespirationRegularity']) &lt;= 1">extension with URL = 'http://dips.no/fhir/R4/StructureDefinition/NoImplVitalSignsObservationRespirationRegularity': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://dips.no/fhir/R4/StructureDefinition/NoImplVitalSignsObservationRespirationDepth']) &lt;= 1">extension with URL = 'http://dips.no/fhir/R4/StructureDefinition/NoImplVitalSignsObservationRespirationDepth': maximum cardinality of 'extension' is 1</sch:assert>
